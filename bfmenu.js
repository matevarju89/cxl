  ...
  var speeroMenuTest = {
    ...
    addMenuObserver: function () {
      ...
      var menuObserver = new MutationObserver(function () {
        if (document.querySelector('#___gatsby nav') && !document.querySelector('.speero-menu')) {
          self.addMenu();
          self.checkWindow();
          self.addMenuEvents();
          this.disconnect();
      ...
      menuObserver.observe(document.getElementById('___gatsby'), {
        childList: true,
        subtree: true,
      });
    },
    ...
    addMenu: function () {
      var userCountry = window.iButterflyNetwork ? window.iButterflyNetwork.user.country : 'us';
      var userLang = window.iButterflyNetwork ? window.iButterflyNetwork.user.language : 'en';
      document.querySelector('#___gatsby nav>div>a').insertAdjacentHTML('afterend', this.menuHTML);
      document
      ...
      document
        ...
        .setAttribute(
          'href',
          'https://store.butterflynetwork.com/' + userCountry + '/' + userLang + '/pricing'
        );
    },
    ...
    checkWindow: function () {
      if (window.innerWidth > 991) {
        ...
        this.classManager.removeClass(document.querySelector('.speero-menu'), 'speero-menu-mobile');
      } else {
